---
layout: post.njk
title: Goodbye Dia, Hello Again Chrome
date: 2026-08-28
nice_date: August 28, 2026
tags: published
---
...
I’ve tried a few other browsers in the past, but nothing really grabbed me. Or, they had some of their own quirks that I didn’t love. So I ended up just going back to Chrome.

I missed the tab management features in Dia, but I found that with a few tweaks and plugins I could make Chrome work similarly so the transition wasn’t so painful. Hopefully this is helpful to anyone else who needs to make the switch.

These are the built-in tweaks I made to Chrome’s settings:
1. **Enable “Show Tabs Vertically”.** It was great timing that Chrome enabled vertical tabs in the stable release this year. I’ve become so used to vertical tabs in Dia I don’t think I can ever go back to horizontal tabs again.
2. **Remap “Collapse Vertical Tabs” to `⌘+⌥+S`.** The best part about vertical tabs is being able to quickly reclaim the space when you want to. This key combo was Dia’s and I couldn’t get rid of the muscle memory.

Then I had to use a couple of extensions to replicate other capabilities:
